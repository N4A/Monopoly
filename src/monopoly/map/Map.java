...
public class Map {
	...
	public int getEventCellSize() {
		return eventCells.size();
	}
	...
	public int getIndex(Cell cell) {
		return eventCells.indexOf(cell);
	}
	...
	public void moveToHospital(Player player) {
		player.getCell().rmCreature(player);
		if (hospital == null)
			return ;
		hospital.getCell().addCreature(player);
		player.setCell(hospital.getCell());
	}
